...
namespace Chanikyahub\PdfInvoice\Model\Order\Pdf;
...
abstract class AbstractPdf extends \Magento\Framework\DataObject
{
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        if (!$order->getIsVirtual()) {
            ...
            $page->drawText(__('Payment Method BY Cash or Card:'), 285, $top - 15, 'UTF-8');
        }
        ...
        if (!$order->getIsVirtual()) {
            ...
            $this->_setFontBold($page, 12);
            $page->setFillColor(new \Zend_Pdf_Color_GrayScale(0));
            $page->drawText(__('Payment Mode'), 35, $this->y, 'UTF-8');
            $page->drawText(__('Shipping Mode:'), 285, $this->y, 'UTF-8');
